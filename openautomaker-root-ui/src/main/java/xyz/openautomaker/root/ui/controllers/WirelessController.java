...
import xyz.openautomaker.root.ui.remote.WifiStatusResponse;
...
public class WirelessController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		wirelessOff.setText(OpenAutoMakerEnv.getI18N().t("wireless.offLabel"));
		wirelessOn.setText(OpenAutoMakerEnv.getI18N().t("wireless.onLabel"));
		ssidLabel.setText(OpenAutoMakerEnv.getI18N().t("wireless.ssidLabel"));
		passwordLabel.setText(OpenAutoMakerEnv.getI18N().t("wireless.passwordLabel"));
		wirelessTitle.setText(OpenAutoMakerEnv.getI18N().t("wireless.title"));
		savePrompt.setText(OpenAutoMakerEnv.getI18N().t("common.savePrompt"));
		ssidField.setPromptText(OpenAutoMakerEnv.getI18N().t("wireless.ssidPrompt"));
		passwordField.setPromptText(OpenAutoMakerEnv.getI18N().t("wireless.passwordPrompt"));

...
public class HomeController implements Initializable, Page {
	...
	private final String rightNozzleTitle = OpenAutoMakerEnv.getI18N().t("common.rightNozzle");
	private final String leftNozzleTitle = OpenAutoMakerEnv.getI18N().t("common.leftNozzle");
	private final String nozzlesTitle = OpenAutoMakerEnv.getI18N().t("common.nozzles");
	private final String nozzleTitle = OpenAutoMakerEnv.getI18N().t("common.nozzle");
	...
	private void updatePrinterStatus(PrinterStatusResponse printerStatus) {
		if (printerStatus != null) {
			...
			Platform.runLater(() -> {
				...
				modelLabel.setText(OpenAutoMakerEnv.getI18N().t(md.model));
	...
	private void updatePrintStatus(PrinterStatusResponse printerStatus)
	{
		...
		if (jobStatusText.startsWith("heating-"))
			jobStatusText = OpenAutoMakerEnv.getI18N().t("common." + jobStatusText.replace('-', '.'));

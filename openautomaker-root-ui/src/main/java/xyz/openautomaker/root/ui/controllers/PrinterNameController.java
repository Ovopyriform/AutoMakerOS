...
public class PrinterNameController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		nameLabel.setText(OpenAutoMakerEnv.getI18N().t("printerName.nameLabel"));
		nameTitle.setText(OpenAutoMakerEnv.getI18N().t("printerName.title"));
		savePrompt.setText(OpenAutoMakerEnv.getI18N().t("common.savePrompt"));
		nameField.setPromptText(OpenAutoMakerEnv.getI18N().t("printerName.enterName"));

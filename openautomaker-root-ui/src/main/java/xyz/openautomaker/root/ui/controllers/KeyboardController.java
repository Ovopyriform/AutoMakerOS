...
"("
		...
		backspaceKey.setText(OpenAutoMakerEnv.getI18N().t(backspaceKey.getText()));
		enterKey.setText(OpenAutoMakerEnv.getI18N().t(enterKey.getText()));
		shiftKey.setText(OpenAutoMakerEnv.getI18N().t(shiftKey.getText()));
		spaceKey.setText(OpenAutoMakerEnv.getI18N().t(spaceKey.getText()));
		keyboardLowercaseText = OpenAutoMakerEnv.getI18N().t(keyboardLowercaseText);
		keyboardUppercaseText = OpenAutoMakerEnv.getI18N().t(keyboardUppercaseText);

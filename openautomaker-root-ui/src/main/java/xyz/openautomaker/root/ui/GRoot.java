package xyz.openautomaker.root.ui;
...
import xyz.openautomaker.root.ui.controllers.RootStackController;
...
public class GRoot extends Application {
	...
	public static void main(String[] args) {
		...
		OpenAutoMakerEnv.get().setLocale(Locale.forLanguageTag(COMMAND_LINE_ARGS.languageTag));

...
import xyz.openautomaker.root.ui.remote.PrintJobData;
import xyz.openautomaker.root.ui.remote.PrintJobListData;
...
public class PrintController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		pageNumberFormat = OpenAutoMakerEnv.getI18N().t(pageNumberFormat);
		...
		reprintTitleText = OpenAutoMakerEnv.getI18N().t(reprintTitleText);
		usbPrintTitleText = OpenAutoMakerEnv.getI18N().t(usbPrintTitleText);
		loadingDetailsText = OpenAutoMakerEnv.getI18N().t(loadingDetailsText);
		loadingTitleText = OpenAutoMakerEnv.getI18N().t(loadingTitleText);
		noSuitableJobsTitleText = OpenAutoMakerEnv.getI18N().t(noSuitableJobsTitleText);
		noSuitableJobsDetailsText = OpenAutoMakerEnv.getI18N().t(noSuitableJobsDetailsText);
		noJobsTitleText = OpenAutoMakerEnv.getI18N().t(noJobsTitleText);
		noJobsDetailsText = OpenAutoMakerEnv.getI18N().t(noJobsDetailsText);
		noMediaTitleText = OpenAutoMakerEnv.getI18N().t(noMediaTitleText);
		noMediaDetailsText = OpenAutoMakerEnv.getI18N().t(noMediaDetailsText);
		noPrinterTitleText = OpenAutoMakerEnv.getI18N().t(noPrinterTitleText);
		noPrinterDetailsText = OpenAutoMakerEnv.getI18N().t(noPrinterDetailsText);
		errorTitleText = OpenAutoMakerEnv.getI18N().t(errorTitleText);
		errorDetailsText = OpenAutoMakerEnv.getI18N().t(errorDetailsText);

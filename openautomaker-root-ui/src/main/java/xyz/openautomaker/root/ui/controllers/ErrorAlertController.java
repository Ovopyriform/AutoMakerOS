...
import xyz.openautomaker.root.ui.remote.ErrorDetails;
...
public class ErrorAlertController {
	...
	public void prepareDialog() {
		abortText = OpenAutoMakerEnv.getI18N().t(abortText);
		clearText = OpenAutoMakerEnv.getI18N().t(clearText);
		continueText = OpenAutoMakerEnv.getI18N().t(continueText);
		retryText = OpenAutoMakerEnv.getI18N().t(retryText);
		ejectFilament1Text = OpenAutoMakerEnv.getI18N().t(ejectFilament1Text);
		ejectFilament2Text = OpenAutoMakerEnv.getI18N().t(ejectFilament2Text);
		dialogTitleText = OpenAutoMakerEnv.getI18N().t(dialogTitleText);

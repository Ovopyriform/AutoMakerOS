...
public class GCodeViewerConfiguration {
	...
	public static GCodeViewerConfiguration loadFromJSON(Path configDirectory) {
		...
		if (configDirectory != null) {
			...
			try {
				...
				LOGGER.error("Couldn't load custom configuration from \"" + configPath + " \" - using installed configuration file");
				configuration = null;
			}
		}
		...
		if (configuration == null) {
			...
			try {
				...
				LOGGER.error("Couldn't load configuration from \"" + configPath + " \" - using defaults");
	...
	public static String getApplicationInstallDirectory() {
		...
		//		{
		//			LOGGER.error("Couldn't load configuration - the application cannot derive the install directory");
		//		}
		//
		...
		//			{
		//				LOGGER.error("URI Syntax Exception whilst attempting to determine the application path - the application is unlikely to run correctly.");
		//			} catch (IOException ex)
		//			{
		//				LOGGER.error("IO Exception whilst attempting to determine the application path - the application is unlikely to run correctly.");
		//			}
		//		}
		//

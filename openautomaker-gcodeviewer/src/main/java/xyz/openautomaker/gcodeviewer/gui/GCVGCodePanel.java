...
import static org.lwjgl.nuklear.Nuklear.NK_BUTTON_DEFAULT;
import static org.lwjgl.nuklear.Nuklear.NK_BUTTON_LEFT;
import static org.lwjgl.nuklear.Nuklear.NK_BUTTON_REPEATER;
import static org.lwjgl.nuklear.Nuklear.NK_EDIT_ACTIVE;
import static org.lwjgl.nuklear.Nuklear.NK_EDIT_SIMPLE;
import static org.lwjgl.nuklear.Nuklear.NK_KEY_CTRL;
...
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_ACTIVE;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_ENTERED;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_HOVER;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_HOVERED;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_INACTIVE;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_LEFT;
import static org.lwjgl.nuklear.Nuklear.NK_WIDGET_STATE_MODIFIED;
import static org.lwjgl.nuklear.Nuklear.NK_WINDOW_NO_SCROLLBAR;
import static org.lwjgl.nuklear.Nuklear.nk_begin;
import static org.lwjgl.nuklear.Nuklear.nk_button_label;
import static org.lwjgl.nuklear.Nuklear.nk_button_set_behavior;
...
import static org.lwjgl.nuklear.Nuklear.nk_input_has_mouse_click;
import static org.lwjgl.nuklear.Nuklear.nk_input_has_mouse_click_down_in_rect;
import static org.lwjgl.nuklear.Nuklear.nk_input_has_mouse_click_in_rect;
import static org.lwjgl.nuklear.Nuklear.nk_input_is_key_down;
import static org.lwjgl.nuklear.Nuklear.nk_input_is_key_pressed;
...
import static org.lwjgl.nuklear.Nuklear.nk_input_is_mouse_prev_hovering_rect;
...
import static org.lwjgl.nuklear.Nuklear.nk_layout_space_to_screen;
import static org.lwjgl.nuklear.Nuklear.nk_property_int;
import static org.lwjgl.nuklear.Nuklear.nk_rect;
import static org.lwjgl.nuklear.Nuklear.nk_widget_has_mouse_click_down;
...
import static org.lwjgl.nuklear.Nuklear.nk_window_get_height;
import static org.lwjgl.nuklear.Nuklear.nk_window_is_hovered;
import static org.lwjgl.system.MemoryStack.stackPush;
import static org.lwjgl.system.MemoryUtil.memASCII;
import static xyz.openautomaker.gcodeviewer.engine.renderers.GUIRenderer.GUI_GCODE_PANEL_X;
import static xyz.openautomaker.gcodeviewer.gui.GCVControlPanel.GUI_CONTROL_PANEL_WIDTH;
...
public class GCVGCodePanel extends GCVPanel {
	...
	public void setLayerMap(Map<Integer, LayerDetails> layerMap) {
		...
		linesReloaded = true;
		if (layerMap != null) {
			this.layerList = new ArrayList<Integer>(this.layerMap.keySet());
	...
	private void layoutVerticalScrollbar(NkContext ctx, NkRect barBounds, float viewLines, RenderParameters renderParameters) {
		try (MemoryStack stack = stackPush()) {
			...
			{
				float cursorFraction = viewLines / totalNumberOfLines;
				...
				beforeHeight = remainingHeight * (lineOffset / maxOffset);
			...
			RenderParameters renderParameters)
	{
		...
		if (left_mouse_down && left_mouse_click_in_cursor && !left_mouse_clicked) {
			...
			if (isVertical) {
				...
				float cursorY = barBounds.y() + (newOffset / maxOffset) * (barBounds.h() - cursorBounds.h());
				...
				float cursorX = barBounds.x() + (newOffset / maxOffset) * (barBounds.w() - cursorBounds.w());

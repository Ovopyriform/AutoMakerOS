...
import org.openautomaker.base.postprocessor.nouveau.OutputUtilities;
...
//    }
    ...
    public void testSuppressUnnecessaryToolChangesAndInsertToolchangeCloses()
    {
        ...
        Optional<RoboxProfile> optionalRoboxProfile = RoboxProfileSettingsContainer.getInstance().getRoboxProfileWithName("Draft", Slicer.CURA, "RBX01-DM");

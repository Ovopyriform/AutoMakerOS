...
import org.openautomaker.base.postprocessor.nouveau.NozzleAssignmentUtilities;
import org.openautomaker.base.postprocessor.nouveau.PostProcessingMode;
...
public class NozzleAssignmentUtilitiesTest extends BaseEnvironmentConfiguredTest
{
    ...
    public void testAssignExtrusionToCorrectExtruder()
    {
        ...
        Optional<RoboxProfile> optionalRoboxProfile = RoboxProfileSettingsContainer.getInstance().getRoboxProfileWithName("Draft", Slicer.CURA, "RBX01-SM");

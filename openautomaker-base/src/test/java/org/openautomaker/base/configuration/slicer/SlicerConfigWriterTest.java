...
public class SlicerConfigWriterTest extends BaseEnvironmentConfiguredTest {
	...
	public void testOptionalOperatorConditionSucceeds() throws IOException {
		...
		SlicerConfigWriter configWriter = SlicerConfigWriterFactory.getConfigWriter(Slicer.CURA);
		...
		configWriter.generateConfigForSlicerWithMappings(printerSettings.getSettings("RBX01-SM", Slicer.CURA), destinationFile, mappingData);
	...
	public void testGenerateConfigForRaftOnCuraDraft() throws IOException {
		...
		configWriter.generateConfigForSlicer(printerSettings.getSettings("RBX01-SM", Slicer.CURA), destinationFile);
		List<String> outputData = readLines(destinationFile.toFile());

...
import static xyz.openautomaker.environment.OpenAutoMakerEnv.CURA_ENGINE;
...
import xyz.openautomaker.base.utils.exporters.MeshExportResult;
import xyz.openautomaker.base.utils.exporters.MeshFileOutputConverter;
import xyz.openautomaker.base.utils.exporters.STLOutputConverter;
		...
		switch (machineType) {
			...
			case WINDOWS:
				...
				for (int i = 0; i < createdMeshFiles.size(); i++) {
					if (slicerType != SlicerType.Cura && previousExtruder != extrudersForMeshes.get(i)) {

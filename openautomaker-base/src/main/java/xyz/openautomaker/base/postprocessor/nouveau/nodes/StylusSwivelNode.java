 ...
 * @author Ian
 */
public class StylusSwivelNode extends GCodeEventNode implements MovementProvider, FeedrateProvider, SupportsPrintTimeCalculation, Renderable, MergeableWithToolchange
{
    ...
    @Override
    public StylusSwivelNode clone()
    {
        StylusSwivelNode returnedNode = new StylusSwivelNode();

        ...
        if (letter != null)
        {
            switch (letter)
            {
                ...
                case "D":
                    ...
                    break;
                default:
					LOGGER.error("Couldn't look up extruder index: " + letter);
                    break;
            }
        } else
        {
			LOGGER.error("Asked to look up extruder index when it was not set");
        }
    ...
    public static String getExtruderLetterForNumber(int number)
    {
        ...
        switch (number)
        {
            ...
            case 1:
                ...
                break;
            default:
				LOGGER.error("Couldn't look up extruder number: " + number);
                break;
        }

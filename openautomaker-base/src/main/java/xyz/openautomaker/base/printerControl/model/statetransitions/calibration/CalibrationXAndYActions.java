...
public class CalibrationXAndYActions extends StateTransitionActions
{
    ...
    public void doPrintPattern() throws PrinterException, RoboxCommsException, InterruptedException, CalibrationException
    {
        ...
        {
			printer.executeGCodeFile(BaseConfiguration.getApplicationModelDirectory().resolve("rbx_test_xy-offset-1_roboxised.gcode"), false);
        } else
        {
			printer.executeGCodeFile(BaseConfiguration.getApplicationModelDirectory().resolve("rbx_test_xy-offset-1_dm_roboxised.gcode"), false);
        }

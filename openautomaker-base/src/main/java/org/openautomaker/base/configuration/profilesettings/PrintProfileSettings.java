package org.openautomaker.base.configuration.profilesettings;
...
public class PrintProfileSettings
{
    ...
    public List<Pair<PrintProfileSetting, String>> getAllEditableSettingsWithSections()
    {
        ...
        {
            Pair settingSectionPair = new Pair(setting, OpenAutomakerEnv.getI18N().t("printProfileSettings.qualitySettings"));

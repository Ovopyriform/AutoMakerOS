package org.openautomaker.base.configuration.utils;
...
public class RoboxProfileUtils 
{
     ...
     */
    public static double calculateRaftOffset(RoboxProfile profileSettings, Slicer slicerType)
    {
    ...
    { 
        ...
        if(newProfile.exists())
        {
			...
			LOGGER.error("Problem when trying to convert old profile: " + profileName 

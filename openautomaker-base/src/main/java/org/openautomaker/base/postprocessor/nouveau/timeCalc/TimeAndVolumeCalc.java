...
import org.openautomaker.base.postprocessor.nouveau.nodes.SkirtSectionNode;
    ...
    public TimeAndVolumeCalcResult calculateVolumeAndTimeOLD(List<LayerPostProcessResult> allLayerPostProcessResults)
    {
                ...
                layerCounter++)
        {
            ...
            while (layerIterator.hasNext())
            {
                ...
                if (node instanceof SupportsPrintTimeCalculation)
                {
                    ...
                    if (lastNodeSupportingPrintTimeCalcs != null)
                    {
                        ...
                        } catch (DurationCalculationException ex)
                        {
                            ...
                            {
								LOGGER.error("Unable to calculate duration correctly for nodes source:"
                    ...
                    if (((FeedrateProvider) lastNodeSupportingPrintTimeCalcs).getFeedrate().getFeedRate_mmPerMin() < 0)
                    {
                        ...
                        {
							LOGGER.warn("Couldn't set feedrate during time calculation");
                        }
                    }
                ...
                {
					LOGGER.trace("Not possible to calculate time for: " + node.getClass().getName() + " : " + node.toString());
                }
                ...
                if (eventDuration > 0)
                {
                    switch (chosenAllocation)
                    {
                        ...
                        case FEEDRATE_INDEPENDENT:
                            ...
                            break;
                        default:
							LOGGER.warn("Event duration was not allocated");
                            break;
                    }

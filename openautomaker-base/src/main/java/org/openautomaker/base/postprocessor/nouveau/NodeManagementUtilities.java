...
public class NodeManagementUtilities
{
    ...
    protected void movePerimeterSections(LayerNode layerNode, LayerPostProcessResult lastLayerParseResult)
    {
		...
		LOGGER.trace("movePerimeterSections(" + Integer.toString(layerNode.getLayerNumber()) + ") ...");
        Iterator<GCodeEventNode> layerIterator = layerNode.treeSpanningIterator(null);
        ...
        if (!perimeterParents.isEmpty() && fillParent != null)
        {
			...
			LOGGER.trace("... moving perimeter sections to be in front of first fill section ...");
    ...
    {
		LOGGER.trace("moveSupportSections(" + Integer.toString(layerNode.getLayerNumber()) + ") ...");
        Iterator<GCodeEventNode> layerIterator = layerNode.treeSpanningIterator(null);
        ...
        {
			LOGGER.trace("Moving support sections to the end");

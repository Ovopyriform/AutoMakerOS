...
public class HeadEEPROMDataResponse extends RoboxRxPacket
{
    ...
    public boolean populatePacket(byte[] byteData, float requiredFirmwareVersion)
    {
        ...
        try
        {
            ...
            {
				LOGGER.error("Couldn't parse maximum temperature - " + maxTempString);
            }
            ...
            {
				LOGGER.error("Couldn't parse thermistor beta - " + thermistorBetaString);
            }
            ...
            {
				LOGGER.error("Couldn't parse thermistor tcal - " + thermistorTCalString);
            }
            ...
            {
				LOGGER.error("Couldn't parse right nozzle X offset - " + nozzle1XOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse right nozzle Y offset - " + nozzle1YOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse right nozzle Z offset - " + nozzle1ZOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse right nozzle B offset - " + nozzle1BOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse left nozzle X offset - " + nozzle2XOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse left nozzle Y offset - " + nozzle2YOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse left nozzle Z offset - " + nozzle2ZOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse left nozzle B offset - " + nozzle2BOffsetString);
            }
            ...
            {
				LOGGER.error("Couldn't parse last filament temperature 1 - "
            ...
            {
				LOGGER.error("Couldn't parse last filament temperature 0 - "
            ...
            {
				LOGGER.error("Couldn't parse hours used - " + hoursUsedString);
            }
        ...
        {
			LOGGER.error("Failed to convert byte array to Head EEPROM Response");
        }

...
public class StatusResponse extends RoboxRxPacket
{
    ...
    public boolean populatePacket(byte[] byteData, float requiredFirmwareVersion)
    {
        ...
        try
        {
            ...
            {
				LOGGER.error("Couldn't parse nozzle temperature - " + nozzle0TemperatureString);
            }
            ...
            {
				LOGGER.error("Couldn't parse nozzle target temperature - "
            ...
            {
				LOGGER.error("Couldn't parse nozzle first layer target temperature - "
            ...
            {
				LOGGER.error("Couldn't parse nozzle temperature - " + nozzle1TemperatureString);
            }
            ...
            {
				LOGGER.error("Couldn't parse bed temperature - " + bedTemperatureString);
            }
            ...
            {
				LOGGER.error("Couldn't parse bed target temperature - " + bedTargetTemperatureString);
            }
            ...
            {
				LOGGER.error("Couldn't parse bed first layer target temperature - "
            ...
            {
				LOGGER.error("Couldn't parse ambient temperature - " + ambientTemperatureString);
            }
            ...
            {
				LOGGER.error("Couldn't parse ambient target temperature - "
            ...
            {
				LOGGER.error("Couldn't parse head X position - " + headXPositionString);
            }
            ...
            {
				LOGGER.error("Couldn't parse head Y position - " + headYPositionString);
            }
            ...
            {
				LOGGER.error("Couldn't parse head Z position - " + headZPositionString);
            }
            ...
            {
				LOGGER.error("Couldn't parse B position - " + BPositionString);
            }
            ...
            if (requiredFirmwareVersion >= 701)
            {
                ...
                {
					LOGGER.error("Couldn't parse nozzle in use - " + nozzleInUseString);
                }
                byteOffset += 1;
            }
            ...
            {
				LOGGER.error("Couldn't parse filament diameter - " + filamentDiameterString);
            }
            ...
            {
				LOGGER.error("Couldn't parse filament multiplier - " + filamentMultiplierString);
            }
            ...
            {
				LOGGER.error("Couldn't parse filament diameter - " + DfilamentDiameterString);
            }
            ...
            {
				LOGGER.error("Couldn't parse filament multiplier - " + DfilamentMultiplierString);
            }
            ...
            {
				LOGGER.error("Couldn't parse D feed rate multiplier - " + feedRateDMultiplierString);
            }
            ...
            if (requiredFirmwareVersion >= 740)
            {
                ...
                {
					LOGGER.error("Couldn't parse E feed rate multiplier - " + feedRateEMultiplierString);
                }
            }
            ...
            if (requiredFirmwareVersion >= 768)
            {
                ...
                {
					LOGGER.error("Couldn't parse nozzle in use - " + hardwareRevString);
                }
            }
        ...
        {
			LOGGER.error("Failed to convert byte array to Status Response");
        }

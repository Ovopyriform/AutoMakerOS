 ...
 * @author ianhudson
 */
public class WriteReel1EEPROM extends RoboxTxPacket
{
    ...
    {
        super(TxPacketTypeEnum.WRITE_REEL_1_EEPROM, false, false);
    }
            ...
            String friendlyName, MaterialType materialType, String displayColourString)
    {
        ...
        {
			LOGGER.error("Unable to encode string: " + friendlyName);
            friendlyNameEncoded = "";
        }
        ...
        if (remainingFilamentValue.length() > 8)
        {
			...
			LOGGER.warn("Truncated remaining filament value from " + oldValue + " to "
    ...
    public byte[] toByteArray()
    {
        ...
        outputArray[0] = TxPacketTypeEnum.WRITE_REEL_1_EEPROM.getCommandByte();
        ...
        if (bufferSize > 1)
        {
            ...
            {
				LOGGER.error("Couldn't encode message for output");
            }
        }

...
/**
 * This deserialiser is used to coerce old project files into the new polymorphic structure In essence anything that doesn't have a type defined in the JSON should be assumed to be an old project file
 *
 * @author Ian
 */

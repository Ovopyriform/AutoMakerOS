...
public class AutoMaker extends Application implements AutoUpdateCompletionListener, InterAppCommsConsumer {
	...
	public static final String AUTOMAKER_ICON_256 = "/xyz/openautomaker/images/AutoMakerIcon_256x256.png";
	public static final String AUTOMAKER_ICON_64 = "/xyz/openautomaker/images/AutoMakerIcon_64x64.png";
	public static final String AUTOMAKER_ICON_32 = "/xyz/openautomaker/images/AutoMakerIcon_32x32.png";
	...
	public void init() throws Exception {
		...
		if (startupStatus == InterAppStartupStatus.STARTED_OK) {
			...
			commsManager = RoboxCommsManager.getInstance(OpenAutoMakerEnv.get().getApplicationPath(SCRIPT), false, Lookup.getUserPreferences().detectLoadedFilamentProperty(),
					Lookup.getUserPreferences().searchForRemoteCamerasProperty());
	...
	private void attachMenus(Stage stage) {
		MenuToolkit tk = MenuToolkit.toolkit(OpenAutoMakerEnv.get().getLocale());
		...
		AboutStageBuilder aboutStageBuilder = AboutStageBuilder.start("About OpenAutoMaker")
				...
				.withVersionString("Version " + OpenAutoMakerEnv.get().getVersion())

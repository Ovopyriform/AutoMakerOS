...
class OALanguageTest {

	I18N oaDefLanguage = new I18N();
	...
	void t_defaultLocale_test() {
		...
		// Check that default language is injected correctly
		I18N defaultLocaleI18N = new I18N(Locale.getDefault());

		for (String translationKey : TRANSLATION_KEYS) {
			assertEquals(defaultLocaleI18N.t(translationKey), oaDefLanguage.t(translationKey));
		}

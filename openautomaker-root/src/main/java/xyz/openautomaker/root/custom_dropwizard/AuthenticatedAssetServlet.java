...
import xyz.openautomaker.root.security.RootAPIUnauthorisedHandler;
...
public class AuthenticatedAssetServlet extends HttpServlet
{
	...
	{
		LOGGER.info("Serving " + req.getScheme() + req.getPathInfo());
			...
			if (authHeader != null)
			{
				...
				if (st.hasMoreTokens())
				{
					...
					if (basic.equalsIgnoreCase("Basic"))
					{
						...
						{
							LOGGER.warn("Couldn't retrieve authentication");
						}
					}
				}
			}
